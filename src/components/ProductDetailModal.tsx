...
function getFeatures(id: string): string[] {
  const map: Record<string, string[]> = {
    ...
    'bundle-all': [
      '🏃 Трекер привычек — streak и прогресс',
      '✅ Трекер задач — приоритеты и дедлайны',
      '💰 Финансовый планер — доходы и расходы',
      '📅 Планер на неделю — цели и задачи',
      '💗 Розовый трекер привычек',
      'Доступ навсегда, без подписки',
    ],
  }
  return map[id] ?? []
