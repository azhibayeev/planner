const reviews = [
  ...
  },
  {
    ...
    rating: 5,
    date: '3 апреля 2026',
    text: 'Пользуюсь уже 3 месяца. Наконец поняла, куда уходят деньги. Графики очень наглядные. Единственное — привыкала около недели, но потом уже автоматически заношу всё.',
  },
  {
    name: 'Сауле Б.',
    avatar: 'СБ',
    ...
    rating: 5,
    date: '28 марта 2026',
    text: 'Работаю фрилансером и это просто находка. Все задачи, дедлайны и статусы в одном месте. Никакой лишней подписки — просто копируешь и работаешь. Уже рекомендую подругам.',
  },
  {
    name: 'Аружан Т.',
    avatar: 'АТ',
